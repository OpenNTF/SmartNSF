...
public enum Strategy {
	SELECT_DOCUMENT_FROM_VIEW_BY_KEY(GetByKey.class), SELECT_DOCUMENT_BY_UNID(GetByUNID.class), SELECT_DOCUMENTS_BY_SEARCH_FT(GetByFT.class), SELECT_DOCUMENTS_BY_FORMULA(GetBySelect.class), SELECT_ALL_DOCUMENTS_BY_VIEW(AllByView.class), SELECT_ALL_DOCUMENTS_FROM_VIEW_BY_KEY(AllByKey.class),
